    ...
    <form action="/posts/{{$post['id']}}" method="POST" class="space-y-5">
        ...
        <div>
            ...
            <textarea
                ...
                id="content"
                rows="4"
                class="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm focus:border-gray-400 focus:ring-0 outline-none p-2 border resize-none">{{$post['content']}}</textarea>
        </div>
